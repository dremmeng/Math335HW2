...
E[\hat{\theta}] &=  2\theta^{2}\\
Bias[\hat{\theta}] & = 2\theta^{2} - \theta \\
\end{split}
\end{equation*}
Then for the Variance by (2):
\begin{equation*}
\begin{split}
Var[\hat{\theta}] &= E[Y_{1}^{4}] - E[Y_{1}^{2}]^{2} \\
&= 24 \theta^{4} - 4\theta^{4} \\
&= 20 \theta^{4} \\
\end{split}
\end{equation*}
\begin{equation*}
\begin{split}
MSE[\hat{\theta}] &= 20\theta^{4} + 4\theta^{4} - 4\theta^{3} + \theta^{2} \\
&= 24\theta^{4} -4\theta^{3} + \theta^{2}
\end{split}
\end{equation*}
\end{enumerate}
\item
